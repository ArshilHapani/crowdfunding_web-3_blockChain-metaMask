...
const CampaignDetails = () => {
  const { contract, address, getDonations, donate } = useStateContext();
    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]">
          <CountBox title="Days" value={remainingDays} />
          <CountBox
            title={`Raise of ${state.target}`}
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[30px] ">
              <input
                ...
                placeholder="ETH 0.1"
                step={0.01}
                className="w-full py-[10px] sm:px-[20px] px-[15px] outline-none border-[1px] border-[#3a3a43] bg-transparent caret-[#1dc071] font-epilogue text-white text-[18px] leading-[30px] placeholder:text-[#4b5264] rounded-[10px]"
                value={amount}
